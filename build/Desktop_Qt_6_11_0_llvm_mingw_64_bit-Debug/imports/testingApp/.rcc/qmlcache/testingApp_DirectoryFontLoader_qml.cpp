// /qt/qml/testingApp/DirectoryFontLoader.qml
...
0x60,0xa,0x0,0x0,0x59,0x18,0xc6,0x24,
0xf1,0x6f,0xa4,0x2f,0x8,0xdf,0xb5,0xef,
0x7b,0x71,0xf8,0xd9,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x23,0x0,0x0,0x0,
0x22,0x0,0x0,0x0,0xb8,0x3,0x0,0x0,
...
0xc8,0x2,0x0,0x0,0xa8,0x3,0x0,0x0,
...
0x40,0x6,0x0,0x0,0x80,0x6,0x0,0x0,
...
#endif
while (!aotContext->loadScopeObjectPropertyLookup(1, &s.v2_8)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(10);
#endif
...
// generate_Add
s.v2_10 = QUrl(QString(std::move(s.v2_4) + std::move(s.v2_8)));
{
}
// generate_StoreReg
{
...
const auto doCall = [&]() {
    ...
    return aotContext->callObjectPropertyLookup(2, s.v2_0, args, 1);
};
const auto doInit = [&]() {
    aotContext->initCallObjectPropertyLookup(2, s.v2_0, 71);
};
#ifndef QT_NO_DEBUG
...
// generate_Ret
if (argv[0]) {
    *static_cast<QUrl *>(argv[0]) = std::move(s.v2_14);
}
return;
}
...
// generate_LoadRuntimeString
s.v2_4 = QVariant::fromValue(QStringLiteral("*.otf"));
{
}
// generate_StoreReg
{
...
s.v2_8 = QStringList{std::move(s.v2_0), aotContext->engine->fromVariant<QString>(std::move(s.v2_4))};
{
}
{
}
